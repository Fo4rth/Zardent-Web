...
$_SESSION['msg']="Hazard Created !!";

}

if(isset($_GET['del']))
		  {
		          mysqli_query($bd, "delete from Hazard where id = '".$_GET['id']."'");
...
<label class="control-label" for="basicinput">Hazard Name</label>
<div class="controls">
