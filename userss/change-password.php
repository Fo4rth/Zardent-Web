...
{
$sql=mysqli_query($bd, "SELECT password FROM  users where password='".$_POST['password']."' && userEmail='".$_SESSION['login']."'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
 $con=mysqli_query($bd, "update users set password='".$_POST['newpassword']."', updationDate='$currentTime' where userEmail='".$_SESSION['login']."'");
