...
$complainno=$cmpn;
echo '<script> alert("Your complain has been successfully.!")</script>';
}
?>
...
<html lang="en">
  <head>
    ...
    <title>User Hazard Complaint</title>
     ...
     <?php include("includes/header.php");?>
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> Register Report</h3>
...
<label class="col-sm-2 col-sm-2 control-label">Type of Hazard</label>
<div class="col-sm-4">
...
<label class="col-sm-2 col-sm-2 control-label">Brgy</label>
<div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">House no./ Street</label>
<div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">Hazard Details</label>
<div class="col-sm-6">
